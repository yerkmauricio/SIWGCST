...
@section('content_header')
    ...
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <strong>Lista de los productos</strong>
            @can('productos.create')
                <a class="btn btn-success float-right" href="{{ route('productos.create') }}">
...
@section('content')
    <h1 style="font-family: 'Times New Roman', Times, serif;">{{ ucfirst('producto') }}</h1>
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <table class="table" id="producto">{{-- el id producto del DATATABLE --}}
                ...
                <tbody>
                    @foreach ($productos as $producto)
                        <tr>
                            ...
                            <td>{{ $producto->precio }}0 Bs</td>
                            <td>{{ ucfirst($producto->categoria) }}</td>
                            <td>{{ $producto->cantidad }} x pers</td>

                            <td><img width="70" height="70" src="{{ Storage::url($producto->foto) }}" alt="">
                            ...
                            <td>
                                ...
                                <form action="{{ route('productos.destroy', $producto) }}" method="POST"
                                    ...
                                    @method('DELETE')
                                    @can('productos.show')
                                        <a class="btn btn-secondary" href="{{ route('productos.show', $producto) }}">
