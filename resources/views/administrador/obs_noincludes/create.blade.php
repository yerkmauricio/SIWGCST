...
@section('content_header')
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body" style="text-align: center;">
            <strong>
                <h1 style="text-transform: uppercase; font-weight: bold;">Formulario para agregar articulos que no incluyen</h1>
            </strong>
        </div>
    </div>
@stop
...
@section('content')
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            ...
            @endif
            <form method="POST" action="{{ route('obs_noincludes.store') }}" >
                @csrf
