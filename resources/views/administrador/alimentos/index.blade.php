...
@section('content_header')
    ...
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <strong>Lista de los alimentos</strong>
            @can('alimentos.create')
                <a class="btn btn-success float-right" href="{{ route('alimentos.create') }}">
...
@section('content')
    <h1 style="font-family: 'Times New Roman', Times, serif;">{{ ucfirst('alimento') }}</h1>
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <table class="table" id="alimento">{{-- el id producto del DATATABLE --}}
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('alimentos.destroy', $alimento) }}" method="POST"
                                    ...
                                    @can('alimentos.edit')
                                        <a class="btn btn-primary" href="{{ route('alimentos.edit', $alimento) }}">
                                            <i class="fas fa-edit"></i> Editar
                                        </a>
                                    @endcan

                                    @can('alimentos.destroy')
