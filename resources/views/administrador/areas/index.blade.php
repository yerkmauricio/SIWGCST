...
@section('content_header')
    ...
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <strong>Lista de las areas</strong>
            @can('areas.create')
                <a class="btn btn-success float-right" href="{{ route('areas.create') }}">
...
@section('content')
    <h1 style="font-family: 'Times New Roman', Times, serif;">{{ ucfirst('lista de las areas') }}</h1>
    <div class="card" style="font-family: 'Times New Roman', Times, serif;">
        <div class="card-body">
            <table class="table" id="area">{{-- el id destino lla al DATATABLE --}}
                ...
                <tbody>
                    ...
                    @foreach ($areas as $area)
                        <tr>
                            ...
                            <td>{{ ucfirst($area->descripcion) }}</td>
                            <td>
                                @if ($area->estado == 0)
                                    Inactivo
                                @else
                            ...
                            <td>
                                ...
                                <form action="{{ route('areas.destroy', $area) }}" method="POST" class="form-eliminar">
                                    @csrf
                                    @method('DELETE')
                                    @can('areas.edit')
                                        <a class="btn btn-primary" href="{{ route('areas.edit', $area) }}">
