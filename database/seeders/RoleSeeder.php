...
class RoleSeeder extends Seeder
{
  ...
  public function run(): void
  {
    ...
    Permission::create(['name' => 'dashboard', 'description' => 'Acceso a la página de principal'])->assignRole([$role0, $role1, $role2, $role3, $role4, $role5]);
    ...
    Permission::create(['name' => 'calendarios.edit', 'description' => 'Ver los pax del calendario'])->assignRole([$role0, $role1, $role2, $role3, $role4, $role5]);
    Permission::create(['name' => 'calendarios.show', 'description' => 'Mostrar los tours del calendario'])->assignRole([$role0, $role1, $role2, $role3, $role4, $role5]);
